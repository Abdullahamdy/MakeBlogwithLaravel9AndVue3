...
Route::middleware('auth:sanctum')->delete('categories/{category}', [CategoryController::class, 'delete']);
...
Route::get('dashboard-posts/{post:slug}', [PostController::class, 'show']);
...
Route::middleware('auth:sanctum')->delete('posts/{post}', [PostController::class, 'delete']);
